...
{{--
    Lightweight inline SVG icon set (§18) — no icon package at runtime, no
    emoji. Icons are Lucide-style (24x24, stroke-based, MIT-licensed
    shapes) inlined directly so there's zero extra HTTP request and no new
    dependency, per §25's "keep the architecture simple" constraint.

    Usage: <x-icon name="bell" class="h-5 w-5" />
--}}
...
@php
    $paths = [
        ...
        'store' => '<path d="m2 7 1.5-4h17L22 7"/><path d="M2 7v13a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V7"/><path d="M2 7h20"/><path d="M9 21V12h6v9"/>',
...
<svg
    {{ $attributes->merge(['class' => 'runix-icon']) }}
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
    stroke-width="2"
