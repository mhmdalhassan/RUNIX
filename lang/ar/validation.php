...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'تم العثور على قيمة :attribute هذه ضمن تسريب بيانات. يرجى اختيار :attribute مختلف.',
    ],
    ...
    */
    ...
    |
    | Phase 9 — RunIX's own field names (gathered from every
    | app/Http/Requests/*.php rule set), so a message like "حقل :attribute
    | مطلوب" reads as a real Arabic label instead of a raw English/
    ...
    */
    ...
    'attributes' => [
        ...
        'pickup_latitude' => 'خط عرض نقطة الاستلام',
        'pickup_longitude' => 'خط طول نقطة الاستلام',
        'delivery_address' => 'عنوان التسليم',
        'delivery_latitude' => 'خط عرض نقطة التسليم',
        'delivery_longitude' => 'خط طول نقطة التسليم',
        'delivery_fee' => 'رسوم التوصيل',
        'merchant_amount' => 'مبلغ التاجر',
        'cod_amount' => 'مبلغ الدفع عند الاستلام',
        'fee_payer' => 'جهة دفع الرسوم',
        'driver_earning' => 'أرباح السائق',
        'driver_earning_override' => 'تجاوز أرباح السائق',
        'driver_earning_override_reason' => 'سبب تجاوز أرباح السائق',
